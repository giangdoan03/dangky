            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h6 class="card-subtitle mb-2 text-muted mb-1 fw-bold">Address</h6>
                                <p class="card-text" id="address"></p>
                            </div>
                            <div class="mb-4">
                                <h6 class="card-subtitle mb-2 text-muted mb-1 fw-bold">Google Map</h6>
                                <p class="card-text" id="gmap"></p>
                            </div>
                            <div class="mb-4">
                                <h6 class="card-subtitle mb-2 text-muted mb-1 fw-bold">Phone Numbers</h6>
                            ...
                            <div class="mb-4">
                                <h6 class="card-subtitle mb-2 text-muted mb-1 fw-bold">E-mail</h6>
                                <p class="card-text" id="email"></p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h6 class="card-subtitle mb-2 text-muted mb-1 fw-bold">Social Links</h6>
                                <p class="card-text mb-1">
                            ...
                            <div class="mb-4">
                                <h6 class="card-subtitle mb-2 text-muted mb-1 fw-bold">iFrame Links</h6>
