...
<!--<h6 class="text-center bg-dark text-white p-3 m-0">Designed and developed</h6>-->
<footer id="footer" class="footer-wrapper">
    <div class="is-divider divider clearfix has-block" style="max-width: 100%;background-color: #028900;display: block;height: 3px;margin: 1em 0;"></div>
    <div class="container">
            ...
            <div class="section-content relative">
                <div class="row" id="row-1982555116">
                    <div id="col-525487658" class="col medium-6 small-12 large-6">
                        <div class="col-inner" style="line-height: 35px">
                            <h2><strong>Trường THCS Thanh Xuân</strong></h2>
                            <p style="margin-bottom: 0">Địa chỉ: 203 Nguyễn Huy Tưởng, Thanh Xuân Trung, Thanh Xuân, Hà Nội</p>
                    ...
                    <div id="col-1203351300" class="col medium-3 small-12 large-3">
                        <div class="col-inner">
                            ...
                            <div class="social-icons" style="margin-top: 20px">
                                <a href="https://www.facebook.com/thcsthanhxuan.edu.vn/" class="icon">
