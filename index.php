...
<body class="bg-light xxxx">
		...
		<div class="container">
			...
			<div id="box-title-register-success">
				<div class="alert alert-success" role="alert">
					...
					<p>Nhà trường đã gửi xác nhận đăng ký hồ sơ tuyển sinh qua email. Phụ huynh truy cập email để kiểm
						tra thông tin đã đăng ký</p>
				</div>
			</div>
			<div id="register-content" class="register-content">
				...
				<div class="page-content">
					...
					<form action="" id="saveStudent" enctype="multipart/form-data">
						<div class="user-info mt-3">
							<div class="row mb-4">
								<div class="col-12 col-md-4 col-sm-12">
									...
									<input type="text" name="hoten_hocsinh" class="form-control"
							...
							<div class="row mb-4">
								<div class="col-12 col-md-4 col-sm-12">
									...
									<input type="text" name="noisinh" class="form-control" placeholder="Nơi sinh"
										required>
								</div>
								<div class="col-12 col-md-4 col-sm-12">
									<div class="title mb-1">
							...
							<div class="row">
								...
								<div class="col-12 col-md-6 col-sm-12">
									...
									<input type="text" name="ten_truong" class="form-control"
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<select class="form-select" id="toan_1" name="toan-1"
													onchange="get_subject(1)">
													<option value="10">10</option>
													<option value="9">9</option>
												</select>
											...
											<td>
												<select class="form-select" id="toan_2" name="toan-2"
													onchange="get_subject(2)">
													<option value="10">10</option>
													<option value="9">9</option>
												</select>
											...
											<td>
												<select class="form-select" id="toan_3" name="toan-3"
													onchange="get_subject(3)">
													<option value="10">10</option>
													<option value="9">9</option>
												</select>
											...
											<td>
												<select class="form-select" id="toan_4" name="toan-4"
													onchange="get_subject(4)">
													<option value="10">10</option>
													<option value="9">9</option>
												</select>
											...
											<td>
												<select class="form-select" id="toan_5" name="toan-5"
													onchange="get_subject(5)">
													<option value="10">10</option>
													<option value="9">9</option>
												</select>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" id="diem_quy_doi_1"
													name="diemquydoi-1" value="2" readonly>
											</td>
											<td>
												<input type="text" class="form-control" id="diem_quy_doi_2"
													name="diemquydoi-2" value="2" readonly>
											</td>
											<td>
												<input type="text" class="form-control" id="diem_quy_doi_3"
													name="diemquydoi-3" value="2" readonly>
											</td>
											<td>
												<input type="text" class="form-control" id="diem_quy_doi_4"
													name="diemquydoi-4" value="2" readonly>
											</td>
											<td>
												<input type="text" class="form-control" id="diem_quy_doi_5"
													name="diemquydoi-5" value="2" readonly>
											</td>
										</tr>
										<tr>
						...
						<div>
							...
							<div class="row mb-4">
								<div class="col-12 col-md-7 col-sm-12">
									...
									<select class="form-select" name="dien_uu_tien"
										onchange="get_diem_uu_tien(this.value)">
								...
								<div class="col-12 col-md-5 col-sm-12">
									...
									<input type="text" id="diem_uu_tien" name="diem_uu_tien" value="0"
						...
						<div class="title border-bottom mt-4 mb-3">
							<h5>IV. CÁC FILE ĐÍNH KÈM <small>(minh chứng, file ảnh/pdf dung lượng không quá
									5Mb)</small>:
							</h5>
						</div>
						<div class="row">
							<div class="col-12 col-md-4 col-sm-12">
								...
								<div class="input-group mb-3">
									<input type="file" accept=".pdf" onchange="validateFile(this)"
										name="anh_hb_tieu_hoc" class="form-control" id="anh_hb_tieu_hoc" required>
								</div>
							...
							<div class="col-12 col-md-4 col-sm-12">
								<div class="title mb-1">
									Giấy khai sinh bản chính <small>(Ảnh hoặc pdf)</small>:<span
										class="text-red">*</span>
								</div>
								<div class="input-group mb-3">
									<input type="file" accept=".pdf, .jpg, .png" onchange="validateFile(this)"
										name="anh_giay_khai_sinh" class="form-control" id="anh_giay_khai_sinh" required>
								</div>
								<div class="img-preview">
									<img id="output-2"
										onerror="this.onerror=null;this.src='./images/common/default_filetype.png';" />
							...
							<div class="col-12 col-md-4 col-sm-12">
								...
								<div class="input-group mb-3">
									<input type="file" accept=".pdf, .jpg, .png" onchange="validateFile(this)"
										name="anh_giay_xac_nhan_uu_tien" class="form-control"
										id="anh_giay_xac_nhan_uu_tien">
								</div>
								<div class="img-preview">
									<img id="output-3"
										onerror="this.onerror=null;this.src='./images/common/default_filetype.png';" />
						...
						<div class="row">
							<div class="col-12 col-md-4 col-sm-12">
								...
								<div class="input-group mb-3">
									<input type="file" accept=".jpg, .png" onchange="validateFile(this)"
										name="anh_chan_dung" class="form-control" id="anh_chan_dung" required>
								</div>
								<div class="img-preview">
									<img id="output-4"
										onerror="this.onerror=null;this.src='./images/common/default_filetype.png';" />
							...
							<div class="col-12 col-md-4 col-sm-12">
								...
								<div class="input-group mb-3">
									<input type="file" accept=".pdf, .jpg, .png" onchange="validateFile(this)"
										name="anh_cccd" class="form-control" id="anh_cccd" required>
								</div>
								<div class="img-preview">
									<img id="output-5"
										onerror="this.onerror=null;this.src='./images/common/default_filetype.png';" />
							...
							<div class="col-12 col-md-4 col-sm-12">
								<div class="title mb-1">
									Phiếu kê khai thông tin học sinh: <a
										href="/Mau_phieu_ke_khai_thong_tin_hoc_sinh.pdf" download>Tải file mẫu</a><span
										class="text-red">*</span>
								</div>
								<div class="input-group mb-3">
									<input type="file" accept=".pdf" onchange="validateFile(this)"
										name="anh_ban_ck_cu_tru" class="form-control" id="anh_ban_ck_cu_tru" required>
								</div>
								<div class="img-preview">
									<img id="output-6"
										onerror="this.onerror=null;this.src='./images/common/default_filetype.png';" />
						...
						<div class="row">
							<div class="col-12 col-md-4 col-sm-12">
								<div class="title mb-1">
									Đơn đăng ký dự tuyển: <a href="/Don_dang_ky_du_tuyen.pdf" download>Tải file
										mẫu</a><span class="text-red">*</span>
								</div>
								<div class="input-group mb-3">
									<input type="file" accept=".pdf" onchange="validateFile(this)"
										name="don_dk_du_tuyen" class="form-control" id="don_dk_du_tuyen" required>
								</div>
								<div class="img-preview">
									<img id="output-7"
										onerror="this.onerror=null;this.src='./images/common/default_filetype.png';" />
						...
						<div>
							<div class="form-check">
								...
								<label class="form-check-label" for="cam_ket">
									<b>Tôi cam đoan tất cả các thông tin đã khai trên là đúng sự thật. Nếu lời khai
										không
						...
						<div class="row mt-5 mb-5">
							<div class="d-grid gap-2 col-sm-12 col-md-3 mx-auto btn-send-form"
	...
	function get_subject(value) {
		...
		let tong_diem_quy_doi = Number(diem_quy_doi_1) + Number(diem_quy_doi_2) + Number(diem_quy_doi_3) + Number(
			diem_quy_doi_4) + Number(diem_quy_doi_5);
	...
	function get_total_score() {
		...
		let tong_diem_quy_doi = Number(diem_quy_doi_1) + Number(diem_quy_doi_2) + Number(diem_quy_doi_3) + Number(
			diem_quy_doi_4) + Number(diem_quy_doi_5) + Number(diem_uu_tien);
